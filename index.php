...
<body>
    <div class="row">
        <div class="col-xs-2">
            <img src="student.jpg" class="img-thumbnail" alt="Lazy student" width="300" height="214" > 
        </div>
        <div class="col-xs-4">
            <h3 id="text">Powiedz nam czego szukasz...</h3>
        </div>
        <div class="col-xs-6">
            <h3 id="text2">...a my pomożemy Ci to znaleźć :)</h3>
        </div>
...
<!-- Wyglad do ustawiania dla Izy -->
<!-- Div z informacjÄ… o pozycji -->
	<div class="row">
...
<!-- Div z mapÄ… -->
	...
	<div id="gmapCancel" style="display:none;">
		<button type="button" class="btn btn-primary" onclick="hideMapT()">Anuluj zmianę pozycji</button>
	</div>
            ...
            <div class="col-xs-2">
                <button type="button" class="btn btn-primary" id="buttonSearch"><i class="fa fa-search"></i></button>
            </div>
        </div>
        <div class="row">
            ...
            <div class="tab-content" id="tabContent">
                <div id="beer" class="tab-pane fade">
                    ...
                    <p><button type="button" class="btn btn-primary btn-block" id="buttonSearch"><i class="fa fa-money"></i>&emsp;NajtaĂ±sze</button></p>
                    <p><button type="button" class="btn btn-primary btn-block" id="buttonSearch"><i class="fa fa-map-signs"></i>&emsp;NajbliÂżej</button></p>
                </div>
                <div id="restaurant" class="tab-pane fade">
                    ...
                    <p><button type="button" class="btn btn-primary btn-block" id="buttonSearch"><i class="fa fa-money"></i>&emsp;NajtaĂ±sze</button></p>
                    <p><button type="button" class="btn btn-primary btn-block" id="buttonSearch"><i class="fa fa-map-signs"></i>&emsp;NajbliÂżej</button></p>
                    <p><button type="button" class="btn btn-primary btn-block" id="buttonSearch"><i class="fa fa-cutlery"></i>&emsp;ChiĂ±czyk</button></p>
                ...
                <div id="entertainment" class="tab-pane fade">
                    ...
                    <p><button type="button" class="btn btn-primary btn-block" id="buttonSearch"><i class="fa fa-money"></i>&emsp;NajtaĂ±sze</button></p>
                    <p><button type="button" class="btn btn-primary btn-block" id="buttonSearch"><i class="fa fa-map-signs"></i>&emsp;NajbliÂżej</button></p>
                    <p><button type="button" class="btn btn-primary btn-block" id="buttonSearch"><i class="fa fa-ticket"></i>&emsp;Kino/KrĂŞgle/Bilard</button></p>
                ...
                <div id="sport" class="tab-pane fade">
                    ...
                    <p><button type="button" class="btn btn-primary btn-block" id="buttonSearch"><i class="fa fa-money"></i>&emsp;NajtaĂ±sze</button></p>
                    <p><button type="button" class="btn btn-primary btn-block" id="buttonSearch"><i class="fa fa-map-signs"></i>&emsp;NajbliÂżej</button></p>
                    <p><button type="button" class="btn btn-primary btn-block" id="buttonSearch"><i class="fa fa-heart-o"></i>&emsp;SiÂłownie</button></p>
